...
public class MwJavaApiIntegrationTest {
    ...
    private static InterMwApiImplExperimental interMwApi;
    ...
    public static void setUp() throws Exception {
        ...
        interMwApi = new InterMwApiImplExperimental(conf);
    }
    ...
    private void registerPlatform(Platform platform) throws Exception {
        ...
        Location location = new Location(platform.getLocationId(), testLocation, latitude, longitude);
        ...
        assertEquals(testLocation, platform1.getLocation().getDescription());
        assertEquals(latitude, platform1.getLocation().getLatitude(), 0.000001);
        assertEquals(longitude, platform1.getLocation().getLongitude(), 0.000001);

        // list platforms
        List<Platform> platforms = interMwApi.listPlatforms();
        assertEquals(platforms.size(), 1);
        assertEquals(platforms.get(0).getPlatformId(), PLATFORM_ID);
    }
