...
public class HttpPushApiCallbackTest {
    private static final Logger logger = LoggerFactory.getLogger(HttpPushApiCallbackTest.class);
    ...
    public static void main(String[] args) throws Exception {
        new HttpPushApiCallbackTest().manualTest();
    }
}
