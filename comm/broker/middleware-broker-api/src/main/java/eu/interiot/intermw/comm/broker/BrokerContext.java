...
public class BrokerContext {
    ...
    private static void registerServices(List<String> packagesNames) throws MiddlewareException {
        ...
        if (defaultSubscriberClass == null)
            throw new MiddlewareException("defaultdefaultSubscriberClass for " + defaultBroker + " not found");
        if (defaultPublisherClass == null)
            throw new MiddlewareException("defaultPublisherClass for " + defaultBroker + " not found");
